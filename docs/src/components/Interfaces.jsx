...
const Interfaces = () => {
  ...
  const interfaces = [
    {
      name: 'DVI/TMDS/HSTX',
      type: { es: 'Video', en: 'Video' },
      speed: 'Up to 10.2 Gbps',
      pins: '4 differential pairs',
      use: { es: 'Video de alta velocidad', en: 'High-speed video' },
      color: 'from-purple-500 to-purple-700'
    },
    {
      name: 'I2C',
      type: { es: 'Bus Serial', en: 'Serial Bus' },
      speed: '100 kHz - 3.4 MHz',
      pins: '2 (SDA, SCL)',
      use: { es: 'Sensores, EEPROMs', en: 'Sensors, EEPROMs' },
      color: 'from-blue-500 to-blue-700'
    },
    {
      name: 'I2S',
      type: { es: 'Audio', en: 'Audio' },
      speed: 'Up to 48 MHz',
      pins: '3-4 (SCK, WS, SD)',
      use: { es: 'Audio digital', en: 'Digital audio' },
      color: 'from-green-500 to-green-700'
    },
    {
      name: 'USB HID',
      type: { es: 'Dispositivo USB', en: 'USB Device' },
      speed: '1.5 - 480 Mbps',
      pins: '2 (D+, D-)',
      use: { es: 'Teclados, ratones', en: 'Keyboards, mice' },
    ...
    },
    {
      ...
      speed: '12 - 480 Mbps',
      pins: '2 (D+, D-)',
      use: { es: 'Puerto COM virtual', en: 'Virtual COM port' },
      color: 'from-orange-500 to-orange-700'
    },
    {
      name: 'WiFi',
      type: { es: 'Inalámbrico', en: 'Wireless' },
      speed: '150 - 1200 Mbps',
      pins: { es: 'Integrado', en: 'Integrated' },
      use: { es: 'Red inalámbrica', en: 'Wireless networking' },
    ...
    },
    {
      ...
      speed: '1 - 2 Mbps',
      pins: { es: 'Integrado', en: 'Integrated' },
      use: { es: 'Inalámbrico de bajo consumo', en: 'Low-power wireless' },
      color: 'from-indigo-500 to-indigo-700'
    },
    {
      name: 'CAN/TWAI',
      type: { es: 'Industrial', en: 'Industrial' },
      speed: '125 kbps - 1 Mbps',
      pins: '2 (CAN_H, CAN_L)',
      use: { es: 'Automotriz, industrial', en: 'Automotive, industrial' },
      color: 'from-red-500 to-red-700'
    },
    {
      name: 'Ethernet W5500',
      type: { es: 'Red', en: 'Network' },
      speed: '10/100 Mbps',
      pins: { es: 'Interfaz SPI', en: 'SPI interface' },
      use: { es: 'Red cableada', en: 'Wired networking' },
    ...
    },
    {
      ...
      speed: '10/100 Mbps',
      pins: { es: 'Interfaz SPI', en: 'SPI interface' },
      use: { es: 'Red IPv6', en: 'IPv6 networking' },
    ...
    },
    {
      ...
      speed: '16 kbps',
      pins: '1 (Data)',
      use: { es: 'Sensores DS18B20', en: 'DS18B20 sensors' },
      color: 'from-lime-500 to-lime-700'
    },
    {
      name: 'UART 8N1',
      type: { es: 'Serial', en: 'Serial' },
      speed: '9600 - 921600 bps',
      pins: '2 (TX, RX)',
      use: { es: 'Comunicación serial', en: 'Serial communication' },
    ...
    },
    {
      ...
      pins: '2-9 (±12V)',
      use: { es: 'Serial legacy', en: 'Legacy serial' },
    ...
    },
    {
      ...
      speed: 'Up to 10 Mbps',
      pins: '2 (A, B)',
      use: { es: 'Serial larga distancia', en: 'Long-distance serial' },
    ...
    <section className="mb-6 bg-white dark:bg-gray-800 rounded-2xl shadow-2xl p-8 md:p-12">
      ...
      <div className="flex items-center gap-4 mb-8">
        ...
        <h2 className="text-4xl font-bold text-gray-900 dark:text-white">
          {language === 'es' ? 'Interfaces de Comunicación' : 'Communication Interfaces'}
        </h2>
      </div>
        ...
        <table className="w-full border-collapse">
          <thead>
            <tr className="bg-gradient-to-r from-slate-700 to-slate-800 dark:from-slate-800 dark:to-slate-900">
              ...
              <th className="px-6 py-4 text-left text-sm font-bold text-white uppercase tracking-wider border-b-2 border-green-500">
                {language === 'es' ? 'Uso Principal' : 'Main Use'}
              </th>
            </tr>
          </thead>
              ...
              >
                ...
                <td className="px-6 py-4 whitespace-nowrap">
                  <span className="px-3 py-1 bg-gray-100 dark:bg-gray-700 text-gray-700 dark:text-gray-300 rounded-md text-sm font-medium">
                    {typeof iface.type === 'object' ? iface.type[language] : iface.type}
                  </span>
                </td>
                <td className="px-6 py-4 whitespace-nowrap">
                ...
                <td className="px-6 py-4 whitespace-nowrap">
                  <span className="inline-flex items-center gap-1 text-gray-700 dark:text-gray-300">
                    ...
                    {typeof iface.pins === 'object' ? iface.pins[language] : iface.pins}
                  </span>
                </td>
                <td className="px-6 py-4">
                  <span className="text-gray-900 dark:text-white font-medium">
                    {typeof iface.use === 'object' ? iface.use[language] : iface.use}
                  </span>
                </td>
              </tr>
            ))}
      ...
      <div className="mt-8 grid grid-cols-2 md:grid-cols-4 gap-4">
        <div className="bg-gradient-to-br from-blue-50 to-blue-100 dark:from-blue-900/20 dark:to-blue-800/20 rounded-lg p-4 border border-blue-200 dark:border-blue-700">
          ...
          <div className="text-sm text-gray-600 dark:text-gray-400 mt-1">
            {language === 'es' ? 'Interfaces' : 'Interfaces'}
          </div>
        </div>
        ...
        <div className="bg-gradient-to-br from-green-50 to-green-100 dark:from-green-900/20 dark:to-green-800/20 rounded-lg p-4 border border-green-200 dark:border-green-700">
          ...
          <div className="text-sm text-gray-600 dark:text-gray-400 mt-1">
            {language === 'es' ? 'Inalámbricas' : 'Wireless'}
          </div>
        </div>
